...
function PlayerDungeon({ player, selectedDungCard, setSelectedDungCard }) {
    ...
    function handleBuildNewDungeon(index = null) {
        ...
        if (player.id === selfPlayer.id && selectedDungCard) {
            ...
            const res = fetch(`${backendUrlBase}/game/${params.lobbyId}/build-dungeon`, {
                method: 'POST',
                headers: {
    ...
    function handleDestroyDungeon(dungeonId) {
        const res = fetch(`${backendUrlBase}/game/${params.lobbyId}/destroy-dungeon`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    function handleBecomeReady() {
        const res = fetch(`${backendUrlBase}/game/${params.lobbyId}/become-ready`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    function handleAcceptHeroMove() {
        const res = fetch(`${backendUrlBase}/game/${params.lobbyId}/accept-hero-move`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    function handleUseDungeon(dungeonId) {
        const res = fetch(`${backendUrlBase}/game/${params.lobbyId}/use-dungeon`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    function handleUseCutomCardAction(actionId) {
        const res = fetch(`${backendUrlBase}/game/${params.lobbyId}/use-custom-action`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
